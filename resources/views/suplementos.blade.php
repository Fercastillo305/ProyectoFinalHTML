            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/pcbum.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/7" class="h3 text-decoration-none" >Proteina CBUM</a>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/bcaa.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/6" class="h3 text-decoration-none">BCAA</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>30 servicios</li>
                                </ul>
                               <p class="text-center mb-0">$400.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/birdmanProte.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/1" class="h3 text-decoration-none">Birdman Falcon  </a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>45 servicios</li>
                                </ul>
                               <p class="text-center mb-0">$1,470.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/pforzagen.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/4" class="h3 text-decoration-none">FORZAGEN | Proteína </a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>5 lb</li>
                                </ul>
                               <p class="text-center mb-0">$1,199.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/proteazul.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/8" class="h3 text-decoration-none">Proteina vegetal birdman</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>60 servicios</li>
                                </ul>
                               <p class="text-center mb-0">$1,070.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/pree.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/9" class="h3 text-decoration-none">Insane Labz Psicotico</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>35 servicios</li>
                                </ul>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/nitro.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/10" class="h3 text-decoration-none">Nitraflex pre</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>300 gramos</li>
                                </ul>
                               <p class="text-center mb-0">$490.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/mens.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/11" class="h3 text-decoration-none">Vitaminas para hombres</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>180 caps</li>
                                </ul>
                               <p class="text-center mb-0">$314.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/iso.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/12" class="h3 text-decoration-none">Dymatize Proteina Iso</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>5 lb</li>
                                </ul>
                               <p class="text-center mb-0">$1,210.00</p>
                            </div>
                        </div>
                    </div>
