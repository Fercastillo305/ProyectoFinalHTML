...
<div class="container">
    ...
    <table class="table">
        ...
        @foreach($resultados as $item)
                    <tr>
                        ...
                        <td>{{ $item->cantidad }}</td>
                        <td>
                        <a href="{{ route('eliminar', ['id' => $item->id_producto]) }}" class="btn btn-danger " >Eliminar</a>
    ...
    <br>
    <a href="{{ route('comprar') }}" class="btn btn-success btn-lg" onclick="showSuccessMessage()">Continuar con el pedido</a>
@endif

<script>
    function showSuccessMessage() {
        alert('¡Pedido realizado con éxito!'); // You can replace this with your preferred way of displaying a success message.
    }
</script>
    <a href="{{ route('historial') }}" class="btn btn-success btn-lg">Ver historial de compras</a>
</div>
</body>
<br><br><br>
<!-- Start Footer -->
<footer class="bg-dark" id="tempaltemo_footer">
    ...
    <script>
    // Verificar si hay un mensaje de éxito y mostrar el popup
    @if(session('success'))
        Swal.fire({
            title: 'Éxito',
