            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="about.html">Accesorios</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="shop.html">Ofertas</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none" href="#">Proteinas</a></li>
                        <li><a class="text-decoration-none" href="#">Creatinas</a></li>
                        <li><a class="text-decoration-none" href="#">Preentrenos</a></li>
                        <li><a class="text-decoration-none" href="#">BCAAs</a></li>
                        <li><a class="text-decoration-none" href="#">Accesorios mujer</a></li>
                        <li><a class="text-decoration-none" href="#">Accesorios hombre</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none" href="#">Página principal</a></li>
                        <li><a class="text-decoration-none" href="#">Suplementos</a></li>
                        <li><a class="text-decoration-none" href="#">Accesorios </a></li>
                        <li><a class="text-decoration-none" href="#">Ofertas</a></li>
                        <li><a class="text-decoration-none" href="#">Tu cuenta</a></li>
                    </ul>
                </div>
