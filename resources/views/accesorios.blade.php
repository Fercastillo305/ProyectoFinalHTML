            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/straps.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/13" class="h3 text-decoration-none" >Straps</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Color: rosa</li>
                                </ul>
                                <p class="text-center mb-0">$169.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/rodilla2.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/14" class="h3 text-decoration-none">Vendas de rodilla</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Color: gris</li>
                                </ul>
                               <p class="text-center mb-0">$298.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/cinto.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/15" class="h3 text-decoration-none"> Cinturón para Pesas </a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Color: negro</li>
                                </ul>
                               <p class="text-center mb-0">$383.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/smun.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/16" class="h3 text-decoration-none"> Straps con muñequera  </a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Color: negro</li>
                                </ul>
                               <p class="text-center mb-0">$207.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/gillete.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/17" class="h3 text-decoration-none">Gilletes tobillo</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Color: negro</li>
                                </ul>
                               <p class="text-center mb-0">$329.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/bandas.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/18" class="h3 text-decoration-none">Bandas de resistencia</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Negro, rosa</li>
                                </ul>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/ligas.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/19" class="h3 text-decoration-none">Ligas de resistencia</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>5 ligas</li>
                                </ul>
                               <p class="text-center mb-0">$600.00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/pad.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/20" class="h3 text-decoration-none">Almohadilla de barra</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Rosa</li>
                                </ul>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="resources/img/tapete.jpg" style="width: 300px; height: 300px;">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="/single/21" class="h3 text-decoration-none">Tapete de gimnasio</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Negro</li>
                                </ul>
                               <p class="text-center mb-0">$600.00</p>
