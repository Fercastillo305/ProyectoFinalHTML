...
<div class="container">
    <form method="post" action="{{ url('/addProducto') }}" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="descripcion_corta" placeholder="Descripción corta" class="form-control" id="descripcion_corta">
        </div>
        <div class="col-12">
            <label for="descripcion" class="form-label">Descripción larga:</label>
            <textarea name="descripcion" placeholder="Descripción larga" class="form-control" id="descripcion" rows="3"></textarea>
        </div>
        <div class="col-md-6">
            <label for="foto1" class="form-label">Nombre foto 1:</label>
            <input type="text" name="foto1" placeholder="Nombre foto 1" class="form-control" id="foto1">
        </div>
        <div class="col-md-6">
            <label for="foto2" class="form-label">Nombre foto 2:</label>
            <input type="text" name="foto2" placeholder="Nombre foto 2" class="form-control" id="foto2">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <label for="almacen" class="form-label">Cantidad en almacén:</label>
            <input type="number" name="almacen" placeholder="Cantidad en almacén" class="form-control" id="almacen">
        </div>
        <div class="col-md-6">
            <label for="fabricante" class="form-label">Fabricante:</label>
            <input type="text" name="fabricante" placeholder="Fabricante" class="form-control" id="fabricante">
        </div>
        <div class="col-md-6">
            <label for="origen" class="form-label">Origen:</label>
            <input type="text" name="origen" placeholder="Origen" class="form-control" id="origen">
        </div>
        <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li><a class="text-decoration-none" href="/snacks">Snacks</a></li>
                    </ul>
                </div>
